...
const changeStatus = ((row: any) => {
    apiFriendLink("/createFriendLink", { id: row.id, status: row.status }).then((res: any) => {
...
const createFriendLink = () => {
    ...
    apiFriendLink("/createFriendLink", param).then((res: any) => {
...
const deleteFriendLink = () => {
    ElMessageBox.confirm(
        ...
        apiFriendLink("/deleteFriendLink", {
